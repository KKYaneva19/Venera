...
function drawFirstChart() {
    ...
    var chart = new google.visualization.PieChart(document.getElementById('pie-chart-one'));
...
function drawSecondChart() {
    ...
    var chart = new google.visualization.PieChart(document.getElementById('pie-chart-two'));
    chart.draw(data, options);
}
...
function drawThirdChart() {
    ...
    var chart = new google.visualization.PieChart(document.getElementById('pie-chart-three'));
    chart.draw(data, options);
}